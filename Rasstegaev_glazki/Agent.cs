...
namespace GubaidullinGlazki
{
    ...
    public partial class Agent
    {
        ...
        {
            var count = 0;
            var context = Rasstegaev_glazkiEntities.GetContext().ProductSale.Where(p => p.AgentID == ID).ToList();
        ...
        {
            var productSale = Rasstegaev_glazkiEntities.GetContext().ProductSale.Where(p => p.AgentID == ID).ToList();
            var products = Rasstegaev_glazkiEntities.GetContext().Product.ToList();
            decimal sale = 0;
